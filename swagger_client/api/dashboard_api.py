...
class DashboardApi(object):
    ...
    def import_lookml_dashboard(self, lookml_dashboard_id, space_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.import_lookml_dashboard(lookml_dashboard_id, space_id, async=True)
        >>> result = thread.get()
    ...
    def import_lookml_dashboard_with_http_info(self, lookml_dashboard_id, space_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.import_lookml_dashboard_with_http_info(lookml_dashboard_id, space_id, async=True)
        >>> result = thread.get()
        ...
        all_params = ['lookml_dashboard_id', 'space_id', 'body']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def sync_lookml_dashboard(self, lookml_dashboard_id, body, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.sync_lookml_dashboard(lookml_dashboard_id, body, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.sync_lookml_dashboard_with_http_info(lookml_dashboard_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.sync_lookml_dashboard_with_http_info(lookml_dashboard_id, body, **kwargs)  # noqa: E501
            return data

    def sync_lookml_dashboard_with_http_info(self, lookml_dashboard_id, body, **kwargs):  # noqa: E501
        """Update Dashboard  # noqa: E501

        ### Update all linked dashboards to match the specified LookML dashboard.  Any UDD (a dashboard which exists in the Looker database rather than as a LookML file) which has a lookml_link_id which specifies the LookML dashboard's id will be updated so that it matches the current state of the LookML dashboard.  For this operation to succeed the user must have permission to view the LookML dashboard, and only linked dashboards that the user has permission to update will be synced.  To **link** or **unlink** a UDD set the lookml_link_id with [Update Dashboard](#!/Dashboard/update_dashboard)   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.sync_lookml_dashboard_with_http_info(lookml_dashboard_id, body, async=True)
        >>> result = thread.get()
        ...
        all_params = ['lookml_dashboard_id', 'body']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
