...
class UserAttribute(object):
    ...
    def __init__(self, id=None, name=None, label=None, type=None, default_value=None, is_system=None, value_is_hidden=None, user_can_view=None, user_can_edit=None, hidden_value_domain_whitelist=None, can=None):  # noqa: E501
        ...
        self._hidden_value_domain_whitelist = None
        self._can = None
        ...
        if hidden_value_domain_whitelist is not None:
    ...
    def hidden_value_domain_whitelist(self):
        """Gets the hidden_value_domain_whitelist of this UserAttribute.  # noqa: E501

        Destinations to which a hidden attribute may be sent. Once set, cannot be edited.  # noqa: E501

        :return: The hidden_value_domain_whitelist of this UserAttribute.  # noqa: E501
        :rtype: str
        """
    ...
    def hidden_value_domain_whitelist(self, hidden_value_domain_whitelist):
        """Sets the hidden_value_domain_whitelist of this UserAttribute.

        Destinations to which a hidden attribute may be sent. Once set, cannot be edited.  # noqa: E501

        :param hidden_value_domain_whitelist: The hidden_value_domain_whitelist of this UserAttribute.  # noqa: E501
        :type: str
        """
