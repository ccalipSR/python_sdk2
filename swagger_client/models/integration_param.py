...
class IntegrationParam(object):
    ...
    def __init__(self, name=None, label=None, description=None, required=None, has_value=None, value=None, user_attribute_name=None, sensitive=None, per_user=None):  # noqa: E501
    ...
    def required(self):
        ...
        Whether the parameter is required to be set to use the destination. If unspecified, this defaults to false.  # noqa: E501
    ...
    def sensitive(self):
        ...
        Whether the parameter contains sensitive data like API credentials. If unspecified, this defaults to true.  # noqa: E501
    ...
    @property
    def per_user(self):
        """Gets the per_user of this IntegrationParam.  # noqa: E501

        When true, this parameter must be assigned to a user attribute in the admin panel (instead of a constant value), and that value may be updated by the user as part of the integration flow.  # noqa: E501

        :return: The per_user of this IntegrationParam.  # noqa: E501
        :rtype: bool
        """
    ...
    def per_user(self, per_user):
        ...
        :param per_user: The per_user of this IntegrationParam.  # noqa: E501
        :type: bool
        """
